...
export default function AddProperty() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const msg = err.response?.data?.message || err.response?.data?.errors?.[0]?.msg || 'Failed to create listing';
      setError(msg);
    } finally {
      setLoading(false);
    }
    ...
    <div className="page-transition-enter-active">
      <Container className="py-5 max-w-4xl mx-auto">
        <div className="text-center mb-5 fade-in-up">
          <h1 className="display-4 fw-bold text-white mb-2">List New Property</h1>
          <p className="text-muted fs-5">Add details and high-quality photos for your rental.</p>
        </div>
          ...
          <Card.Body>
            ...
            <Form onSubmit={handleSubmit}>
              <Row className="g-4 mb-4">
                <Col md={12}>
                  <Form.Group>
                    ...
                    <Form.Control name="title" value={form.title} onChange={handleChange} required placeholder="e.g. Modern Penthouse with City Views" className="py-3" />
                  </Form.Group>
                </Col>
                ...
                <Col md={12}>
                  <Form.Group>
                    ...
                    <Form.Control as="textarea" rows={5} name="description" value={form.description} onChange={handleChange} required placeholder="Describe what makes your property unique..." />
                  </Form.Group>
                </Col>
                ...
                <Col md={6}>
                  <Form.Group>
                    ...
                    <Form.Control name="city" value={form.city} onChange={handleChange} required placeholder="e.g. New York, London, Tokyo" className="py-3" />
                  </Form.Group>
                </Col>
                ...
                <Col md={12}>
                  <Form.Group>
                    ...
                    <Form.Control name="location" value={form.location} onChange={handleChange} required placeholder="123 Main St, Apartment 4B" className="py-3" />
                  </Form.Group>
                </Col>
                ...
                <Col md={3} xs={6}>
                  <Form.Group>
                    ...
                    <Form.Control type="number" min="0" name="price" value={form.price} onChange={handleChange} required placeholder="1500" className="py-3" />
                  </Form.Group>
                </Col>
                ...
                <Col md={3} xs={6}>
                  <Form.Group>
                    ...
                    <Form.Control type="number" min="0" name="bedrooms" value={form.bedrooms} onChange={handleChange} required placeholder="2" className="py-3" />
                  </Form.Group>
                </Col>
                ...
                <Col md={3} xs={6}>
                  <Form.Group>
                    ...
                    <Form.Control type="number" min="0" name="bathrooms" value={form.bathrooms} onChange={handleChange} required placeholder="1" className="py-3" />
                  </Form.Group>
                </Col>
                ...
                <Col md={3} xs={6}>
                  <Form.Group>
                    ...
                    <Form.Control type="number" min="0" name="area" value={form.area} onChange={handleChange} placeholder="850 (Optional)" className="py-3" />
                  </Form.Group>
                </Col>
                ...
                <Col md={12}>
                  <Form.Group>
                    ...
                    <Form.Control name="amenities" value={form.amenities} onChange={handleChange} placeholder="WiFi, AC, Free Parking, Kitchen, Pool" className="py-3" />
                  </Form.Group>
                </Col>
              ...
              <div className="d-flex justify-content-end gap-3 mt-4">
                <Button as={Link} to="/my-listings" variant="outline-light" className="px-4 py-3 fw-semibold rounded-pill">
                  Cancel
                </Button>
                <Button
                  type="submit"
